...
def readAndParseData16xx(Dataport, configParameters):
    ...
    return dataOK, frameNumber, detObj, rangeDoppler
...
while True:
    try:
        dataOk, frameNumber, detObj, range_doppler = readAndParseData16xx(Dataport, configParameters)

        if dataOk:
            # Store the current frame into frameData
            frameData[currentIndex] = detObj
            range_doppler_arr[currentIndex] = range_doppler
            currentIndex += 1
